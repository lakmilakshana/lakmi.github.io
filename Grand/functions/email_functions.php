...
//                          </v:roundrect><![endif]-->
//                                                        <a href=\"http://localhost:8080/GrandY/activate_account.php?i=${identity}\" class=\"button button--green\">Verify Email</a>
//                                                    </div>
//                                                </td>
//                                            </tr>
//                                        </table>
...
//                                                    </p>
//                                                    <p class=\"sub\"><a href=\"http://localhost:8080/GrandY/activate_account.php?i=${identity}\">Grand</a></p>
//                                                </td>
//                                            </tr>
//                                        </table>
//                                    </td>
...
//    $message = (new Swift_Message('Verify your identity'))
//        ->setFrom([EMAIL => 'Grand business directory'])
//        ->setContentType('text/html')
//        ->setTo([$user->user_mail => $user->user_name])
//        ->setBody($body);
//    return $mailer->send($message);
//}
//

// returns a user that have a $validation_code or false if it doesn't exist
